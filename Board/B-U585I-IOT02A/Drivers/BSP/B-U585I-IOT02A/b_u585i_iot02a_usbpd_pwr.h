/**
  ******************************************************************************
  * @file    b_u585i_iot02a_usbpd_pwr.h
  * @author  MCD Application Team
  * @brief   Header file for b_u585i_iot02a_usbpd_pwr.c file
  ******************************************************************************
  * @attention
  *
...
#ifndef B_U585I_IOT02A_USBPD_PWR_H
#define B_U585I_IOT02A_USBPD_PWR_H
...
/**
  ...
  */
#define TCPP0203_PORT0_FLG_GPIO_CLK_ENABLE()        LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOE);
#define TCPP0203_PORT0_FLG_GPIO_CLK_DISABLE()       LL_AHB2_GRP1_DisableClock(LL_AHB2_GRP1_PERIPH_GPIOE);
#define TCPP0203_PORT0_FLG_GPIO_PORT                GPIOE
...
#define TCPP0203_PORT0_FLG_SET_EXTI()               LL_EXTI_SetEXTISource(LL_EXTI_EXTI_PORTE, (LL_EXTI_EXTI_LINE8));
...
#define TCPP0203_PORT0_ENABLE_GPIO_CLK_ENABLE()     LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOB);
#define TCPP0203_PORT0_ENABLE_GPIO_CLK_DISABLE()    LL_AHB2_GRP1_DisableClock(LL_AHB2_GRP1_PERIPH_GPIOB);
#define TCPP0203_PORT0_ENABLE_GPIO_PORT             GPIOB
#define TCPP0203_PORT0_ENABLE_GPIO_PIN              LL_GPIO_PIN_5
...
#define TCPP0203_PORT0_ADC_INSTANCE                 ADC4
#define TCPP0203_PORT0_ADC_CLK_ENABLE()            __HAL_RCC_ADC4_CLK_ENABLE()
#define TCPP0203_PORT0_ADC_CLK_DISABLE()           __HAL_RCC_ADC4_CLK_DISABLE()
#define TCPP0203_PORT0_ADC_FORCE_RESET()           __HAL_RCC_ADC4_FORCE_RESET()
#define TCPP0203_PORT0_ADC_RELEASE_RESET()         __HAL_RCC_ADC4_RELEASE_RESET()

/* Definition of ADCx channels */
#define TCPP0203_PORT0_IANA_ADC_CHANNEL             ADC_CHANNEL_17          /* PD13 : ADC4_IN17 */
#define TCPP0203_PORT0_VBUSC_ADC_CHANNEL            ADC_CHANNEL_5           /* PF14 : ADC4_IN5 */
#define TCPP0203_PORT0_ADCXCHANNELN                 (2U)

#define TCPP0203_PORT0_IANA_GPIO_CLK_ENABLE()       LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOD);
#define TCPP0203_PORT0_IANA_GPIO_CLK_DISABLE()      LL_AHB2_GRP1_DisableClock(LL_AHB2_GRP1_PERIPH_GPIOD);
#define TCPP0203_PORT0_IANA_GPIO_PORT               GPIOD
...
#endif /* B_U585I_IOT02A_USBPD_PWR_H */
